...
<div class="page-header">
    ...
    <p>Add a new guest, staff member, or admin to the system.</p>
</div>
    ...
    <form method="POST" action="{{ route('admin.users.store') }}">
        ...
        <div class="form-group">
            ...
            <select id="role" name="role" class="form-control @error('role') is-invalid @enderror">
                ...
                <option value="front_desk" {{ old('role') === 'front_desk' ? 'selected' : '' }}>🖥 Front Desk Staff</option>
                <option value="staff"      {{ old('role') === 'staff'      ? 'selected' : '' }}>🧹 Housekeeping Staff</option>
        ...
        <div class="form-grid-2">
            <div class="form-group">
                <label class="form-label">Password <span style="color:var(--rust);">*</span></label>
            ...
            <div class="form-group">
                <label class="form-label">Confirm Password <span style="color:var(--rust);">*</span></label>
