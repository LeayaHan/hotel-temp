    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .navbar {
            ...
            padding: 0 32px;
            box-shadow: 0 2px 24px rgba(44,36,22,.22);
        }
        .navbar-brand {
        ...
        .navbar-brand svg { color: var(--gold); }
        .navbar-links {
        ...
        th {
            padding: 11px 16px; text-align: left; font-size: .78rem;
            font-weight: 600; letter-spacing: .06em; text-transform: uppercase;
            color: var(--muted); border-bottom: 1px solid var(--border); white-space: nowrap;
        }
        td {
            padding: 13px 16px; font-size: .9rem; color: var(--ink);
        ...
        .form-label {
            ...
            color: var(--muted); letter-spacing: .05em; text-transform: uppercase; margin-bottom: 7px;
        }
        .form-control {
        ...
        .pagination .page-link {
            ...
            transition: background .12s; margin: 0 2px;
        }
        ...
        .auth-logo { font-family: 'DM Serif Display', serif; font-size: 1.6rem; color: var(--gold); text-align: center; margin-bottom: 6px; letter-spacing: .01em; }
...
<nav class="navbar">
    ...
    <div class="navbar-links">
        ...
        <a href="{{ route('my-services.create') }}"
           class="nav-link {{ request()->routeIs('my-services.create') ? 'active' : '' }}">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
            New Request
        </a>

        <a href="{{ route('my-services.index') }}"
           class="nav-link {{ request()->routeIs('my-services.*') && !request()->routeIs('my-services.create') ? 'active' : '' }}">
